...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-cloudflare.devicePostureRule.DevicePostureRuleInputLocations",
		reflect.TypeOf((*DevicePostureRuleInputLocations)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-cloudflare.devicePostureRule.DevicePostureRuleInputLocationsList",
		reflect.TypeOf((*DevicePostureRuleInputLocationsList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "allWithMapKey", GoMethod: "AllWithMapKey"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DevicePostureRuleInputLocationsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
