...
import (
	...
	"github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v4/datacloudflareloadbalancerpools/internal"
...
func (j *jsiiProxy_DataCloudflareLoadBalancerPools) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_DataCloudflareLoadBalancerPools)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
