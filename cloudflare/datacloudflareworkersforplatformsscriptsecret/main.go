...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataCloudflareWorkersForPlatformsScriptSecret)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-cloudflare.dataCloudflareWorkersForPlatformsScriptSecret.DataCloudflareWorkersForPlatformsScriptSecretConfig",
		reflect.TypeOf((*DataCloudflareWorkersForPlatformsScriptSecretConfig)(nil)).Elem(),
	)
}
