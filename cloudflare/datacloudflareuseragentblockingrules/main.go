...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetUaSearch", GoMethod: "ResetUaSearch"},
			...
			_jsii_.MemberProperty{JsiiProperty: "uaSearch", GoGetter: "UaSearch"},
			_jsii_.MemberProperty{JsiiProperty: "uaSearchInput", GoGetter: "UaSearchInput"},
