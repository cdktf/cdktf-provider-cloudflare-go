...
func init() {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "connectorIdentifier", GoGetter: "ConnectorIdentifier"},
			_jsii_.MemberProperty{JsiiProperty: "connectorIdentifierInput", GoGetter: "ConnectorIdentifierInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "resetConnectorIdentifier", GoMethod: "ResetConnectorIdentifier"},
