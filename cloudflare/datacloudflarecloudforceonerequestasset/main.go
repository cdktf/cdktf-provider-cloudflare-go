...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "assetIdentifer", GoGetter: "AssetIdentifer"},
			_jsii_.MemberProperty{JsiiProperty: "assetIdentiferInput", GoGetter: "AssetIdentiferInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "requestIdentifier", GoGetter: "RequestIdentifier"},
			_jsii_.MemberProperty{JsiiProperty: "requestIdentifierInput", GoGetter: "RequestIdentifierInput"},
