...
type ZeroTrustDlpCustomProfileProfiles struct {
	...
	ContextAwareness *ZeroTrustDlpCustomProfileProfilesContextAwareness `field:"optional" json:"contextAwareness" yaml:"contextAwareness"`
