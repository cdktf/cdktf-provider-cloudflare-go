...
func (z *jsiiProxy_ZeroTrustAccessGroupRequireGithubOrganizationOutputReference) validateInterpolationForAttributeParameters(property *string) error {
	if property == nil {
...
func (z *jsiiProxy_ZeroTrustAccessGroupRequireGithubOrganizationOutputReference) validateResolveParameters(_context cdktf.IResolveContext) error {
	if _context == nil {
