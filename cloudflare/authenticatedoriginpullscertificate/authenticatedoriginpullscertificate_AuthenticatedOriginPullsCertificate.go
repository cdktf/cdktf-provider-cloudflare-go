...
import (
	...
	"github.com/hashicorp/cdktf-provider-cloudflare-go/cloudflare/v3/authenticatedoriginpullscertificate/internal"
...
func (j *jsiiProxy_AuthenticatedOriginPullsCertificate) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_AuthenticatedOriginPullsCertificate)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
