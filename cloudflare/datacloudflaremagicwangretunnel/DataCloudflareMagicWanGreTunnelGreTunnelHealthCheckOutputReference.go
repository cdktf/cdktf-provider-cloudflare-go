...
func (d *jsiiProxy_DataCloudflareMagicWanGreTunnelGreTunnelHealthCheckOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataCloudflareMagicWanGreTunnelGreTunnelHealthCheckOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
