...
func (z *jsiiProxy_ZeroTrustAccessApplication) validatePutFooterLinksParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*ZeroTrustAccessApplicationFooterLinks; received %#v (a %T)", value, value)
		}
	}
...
func (z *jsiiProxy_ZeroTrustAccessApplication) validatePutTargetCriteriaParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*ZeroTrustAccessApplicationTargetCriteria; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_ZeroTrustAccessApplication) validateSetLifecycleParameters(val *cdktf.TerraformResourceLifecycle) error {
	if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
		return err
	}
