...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*HostnameTlsSettingCiphers)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-cloudflare.hostnameTlsSettingCiphers.HostnameTlsSettingCiphersConfig",
		reflect.TypeOf((*HostnameTlsSettingCiphersConfig)(nil)).Elem(),
	)
}
