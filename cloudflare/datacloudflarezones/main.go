...
func init() {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "lookupType", GoGetter: "LookupType"},
			_jsii_.MemberProperty{JsiiProperty: "lookupTypeInput", GoGetter: "LookupTypeInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetLookupType", GoMethod: "ResetLookupType"},
