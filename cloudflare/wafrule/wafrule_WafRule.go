...
import (
	...
	"github.com/hashicorp/cdktf-provider-cloudflare-go/cloudflare/v3/wafrule/internal"
...
func (j *jsiiProxy_WafRule) GroupId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"groupId",
...
func (j *jsiiProxy_WafRule) Mode() *string {
	var returns *string
	_jsii_.Get(
		j,
		"mode",
...
func (j *jsiiProxy_WafRule) ModeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"modeInput",
...
func (j *jsiiProxy_WafRule) PackageId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"packageId",
...
func (j *jsiiProxy_WafRule) PackageIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"packageIdInput",
...
func (j *jsiiProxy_WafRule) RuleId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ruleId",
...
func (j *jsiiProxy_WafRule) RuleIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ruleIdInput",
...
func (j *jsiiProxy_WafRule) ZoneId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneId",
...
func (j *jsiiProxy_WafRule) ZoneIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneIdInput",
...
func NewWafRule(scope constructs.Construct, id *string, config *WafRuleConfig) WafRule {
	...
	_jsii_.Create(
		"@cdktf/provider-cloudflare.wafRule.WafRule",
...
func (j *jsiiProxy_WafRule)SetMode(val *string) {
...
func (j *jsiiProxy_WafRule)SetPackageId(val *string) {
...
func (j *jsiiProxy_WafRule)SetRuleId(val *string) {
...
func (j *jsiiProxy_WafRule)SetZoneId(val *string) {
...
func (w *jsiiProxy_WafRule) ResetPackageId() {
	_jsii_.InvokeVoid(
		w,
		"resetPackageId",
		nil, // no parameters
