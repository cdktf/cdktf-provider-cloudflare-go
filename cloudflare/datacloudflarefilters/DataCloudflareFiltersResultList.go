...
import (
	...
	"github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v12/datacloudflarefilters/internal"
...
func (d *jsiiProxy_DataCloudflareFiltersResultList) Resolve(_context cdktf.IResolveContext) interface{} {
