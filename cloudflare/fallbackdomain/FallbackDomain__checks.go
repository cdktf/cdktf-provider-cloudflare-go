...
func (f *jsiiProxy_FallbackDomain) validateMoveFromIdParameters(id *string) error {
	if id == nil {
		return fmt.Errorf("parameter id is required, but nil was provided")
	}
...
func (f *jsiiProxy_FallbackDomain) validateMoveToIdParameters(id *string) error {
	if id == nil {
		return fmt.Errorf("parameter id is required, but nil was provided")
	}
...
func (f *jsiiProxy_FallbackDomain) validatePutDomainsParameters(value interface{}) error {
	...
	case *[]*FallbackDomainDomains:
		value := value.(*[]*FallbackDomainDomains)
	...
	case []*FallbackDomainDomains:
		value_ := value.([]*FallbackDomainDomains)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*FallbackDomainDomains; received %#v (a %T)", value, value)
		}
	}
