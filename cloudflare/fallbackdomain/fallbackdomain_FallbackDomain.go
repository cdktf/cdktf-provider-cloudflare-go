...
import (
	...
	"github.com/hashicorp/cdktf-provider-cloudflare-go/cloudflare/v3/fallbackdomain/internal"
...
func (j *jsiiProxy_FallbackDomain) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_FallbackDomain)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
