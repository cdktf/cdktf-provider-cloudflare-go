...
func (c *jsiiProxy_CertificatePack) validatePutValidationErrorsParameters(value interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *[]*CertificatePackValidationErrors:
		value := value.(*[]*CertificatePackValidationErrors)
	...
	case []*CertificatePackValidationErrors:
		value_ := value.([]*CertificatePackValidationErrors)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*CertificatePackValidationErrors; received %#v (a %T)", value, value)
		}
	}
...
func (c *jsiiProxy_CertificatePack) validatePutValidationRecordsParameters(value interface{}) error {
	...
	case *[]*CertificatePackValidationRecords:
		value := value.(*[]*CertificatePackValidationRecords)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*CertificatePackValidationRecords:
		value_ := value.([]*CertificatePackValidationRecords)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*CertificatePackValidationRecords; received %#v (a %T)", value, value)
		}
	}
