...
// The jsii proxy struct for ArgoTunnel
type jsiiProxy_ArgoTunnel struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_ArgoTunnel) AccountId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountId",
...
func (j *jsiiProxy_ArgoTunnel) AccountIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountIdInput",
...
func (j *jsiiProxy_ArgoTunnel) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_ArgoTunnel) Cname() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cname",
...
func (j *jsiiProxy_ArgoTunnel) Connection() interface{} {
...
func (j *jsiiProxy_ArgoTunnel) ConstructNodeMetadata() *map[string]interface{} {
...
func (j *jsiiProxy_ArgoTunnel) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_ArgoTunnel) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_ArgoTunnel) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_ArgoTunnel) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ArgoTunnel) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_ArgoTunnel) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_ArgoTunnel) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_ArgoTunnel) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ArgoTunnel) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_ArgoTunnel) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_ArgoTunnel) Node() constructs.Node {
...
func (j *jsiiProxy_ArgoTunnel) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_ArgoTunnel) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
func (j *jsiiProxy_ArgoTunnel) RawOverrides() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"rawOverrides",
...
func (j *jsiiProxy_ArgoTunnel) Secret() *string {
	var returns *string
	_jsii_.Get(
		j,
		"secret",
...
func (j *jsiiProxy_ArgoTunnel) SecretInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"secretInput",
...
func (j *jsiiProxy_ArgoTunnel) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_ArgoTunnel) TerraformMetaArguments() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ArgoTunnel) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ArgoTunnel) TunnelToken() *string {
	var returns *string
	_jsii_.Get(
		j,
		"tunnelToken",
...
func NewArgoTunnel(scope constructs.Construct, id *string, config *ArgoTunnelConfig) ArgoTunnel {
	...
	_jsii_.Create(
		"@cdktf/provider-cloudflare.argoTunnel.ArgoTunnel",
...
// Experimental.
func ArgoTunnel_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateArgoTunnel_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func ArgoTunnel_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateArgoTunnel_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (a *jsiiProxy_ArgoTunnel) ResetId() {
	_jsii_.InvokeVoid(
		a,
		"resetId",
		nil, // no parameters
...
func (a *jsiiProxy_ArgoTunnel) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		a,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (a *jsiiProxy_ArgoTunnel) SynthesizeAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (a *jsiiProxy_ArgoTunnel) ToMetadata() interface{} {
	var returns interface{}
...
func (a *jsiiProxy_ArgoTunnel) ToString() *string {
	var returns *string
...
func (a *jsiiProxy_ArgoTunnel) ToTerraform() interface{} {
	var returns interface{}
