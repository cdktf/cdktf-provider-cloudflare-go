...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "priorityIdentifer", GoGetter: "PriorityIdentifer"},
			_jsii_.MemberProperty{JsiiProperty: "priorityIdentiferInput", GoGetter: "PriorityIdentiferInput"},
