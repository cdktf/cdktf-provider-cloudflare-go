...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-cloudflare.dataCloudflareFirewallRule.DataCloudflareFirewallRuleFilter",
		reflect.TypeOf((*DataCloudflareFirewallRuleFilter)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-cloudflare.dataCloudflareFirewallRule.DataCloudflareFirewallRuleFilterOutputReference",
		reflect.TypeOf((*DataCloudflareFirewallRuleFilterOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_DataCloudflareFirewallRuleFilterOutputReference{}
