...
// The jsii proxy struct for AccessBookmark
type jsiiProxy_AccessBookmark struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_AccessBookmark) AccountId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountId",
...
func (j *jsiiProxy_AccessBookmark) AccountIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountIdInput",
...
func (j *jsiiProxy_AccessBookmark) AppLauncherVisible() interface{} {
...
func (j *jsiiProxy_AccessBookmark) AppLauncherVisibleInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AccessBookmark) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_AccessBookmark) Connection() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"connection",
...
func (j *jsiiProxy_AccessBookmark) ConstructNodeMetadata() *map[string]interface{} {
...
func (j *jsiiProxy_AccessBookmark) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_AccessBookmark) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_AccessBookmark) Domain() *string {
	var returns *string
	_jsii_.Get(
		j,
		"domain",
...
func (j *jsiiProxy_AccessBookmark) DomainInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"domainInput",
...
func (j *jsiiProxy_AccessBookmark) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_AccessBookmark) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_AccessBookmark) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_AccessBookmark) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_AccessBookmark) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_AccessBookmark) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_AccessBookmark) LogoUrl() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logoUrl",
...
func (j *jsiiProxy_AccessBookmark) LogoUrlInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logoUrlInput",
...
func (j *jsiiProxy_AccessBookmark) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_AccessBookmark) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_AccessBookmark) Node() constructs.Node {
...
func (j *jsiiProxy_AccessBookmark) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_AccessBookmark) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
func (j *jsiiProxy_AccessBookmark) RawOverrides() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"rawOverrides",
...
func (j *jsiiProxy_AccessBookmark) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_AccessBookmark) TerraformMetaArguments() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AccessBookmark) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AccessBookmark) ZoneId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneId",
...
func (j *jsiiProxy_AccessBookmark) ZoneIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneIdInput",
...
func NewAccessBookmark(scope constructs.Construct, id *string, config *AccessBookmarkConfig) AccessBookmark {
	...
	_jsii_.Create(
		"@cdktf/provider-cloudflare.accessBookmark.AccessBookmark",
...
// Experimental.
func AccessBookmark_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateAccessBookmark_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func AccessBookmark_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateAccessBookmark_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (a *jsiiProxy_AccessBookmark) ResetAccountId() {
	_jsii_.InvokeVoid(
		a,
		"resetAccountId",
		nil, // no parameters
...
func (a *jsiiProxy_AccessBookmark) ResetAppLauncherVisible() {
	_jsii_.InvokeVoid(
		a,
		"resetAppLauncherVisible",
		nil, // no parameters
...
func (a *jsiiProxy_AccessBookmark) ResetId() {
	_jsii_.InvokeVoid(
		a,
		"resetId",
		nil, // no parameters
...
func (a *jsiiProxy_AccessBookmark) ResetLogoUrl() {
	_jsii_.InvokeVoid(
		a,
		"resetLogoUrl",
		nil, // no parameters
...
func (a *jsiiProxy_AccessBookmark) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		a,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (a *jsiiProxy_AccessBookmark) ResetZoneId() {
	_jsii_.InvokeVoid(
		a,
		"resetZoneId",
		nil, // no parameters
...
func (a *jsiiProxy_AccessBookmark) SynthesizeAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (a *jsiiProxy_AccessBookmark) ToMetadata() interface{} {
	var returns interface{}
...
func (a *jsiiProxy_AccessBookmark) ToString() *string {
	var returns *string
...
func (a *jsiiProxy_AccessBookmark) ToTerraform() interface{} {
	var returns interface{}
