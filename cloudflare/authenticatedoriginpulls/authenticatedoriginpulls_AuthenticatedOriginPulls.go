...
import (
	...
	"github.com/hashicorp/cdktf-provider-cloudflare-go/cloudflare/v3/authenticatedoriginpulls/internal"
...
func (j *jsiiProxy_AuthenticatedOriginPulls) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
