...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-cloudflare.teamsRule.TeamsRuleRuleSettingsResolveDnsInternally",
		reflect.TypeOf((*TeamsRuleRuleSettingsResolveDnsInternally)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-cloudflare.teamsRule.TeamsRuleRuleSettingsResolveDnsInternallyOutputReference",
		reflect.TypeOf((*TeamsRuleRuleSettingsResolveDnsInternallyOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
