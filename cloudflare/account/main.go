...
func init() {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "defaultNameservers", GoGetter: "DefaultNameservers"},
			_jsii_.MemberProperty{JsiiProperty: "defaultNameserversInput", GoGetter: "DefaultNameserversInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetDefaultNameservers", GoMethod: "ResetDefaultNameservers"},
			_jsii_.MemberMethod{JsiiMethod: "resetEnforceTwofactor", GoMethod: "ResetEnforceTwofactor"},
			_jsii_.MemberMethod{JsiiMethod: "resetUseAccountCustomNsByDefault", GoMethod: "ResetUseAccountCustomNsByDefault"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
			_jsii_.MemberProperty{JsiiProperty: "useAccountCustomNsByDefault", GoGetter: "UseAccountCustomNsByDefault"},
			_jsii_.MemberProperty{JsiiProperty: "useAccountCustomNsByDefaultInput", GoGetter: "UseAccountCustomNsByDefaultInput"},
		},
		func() interface{} {
