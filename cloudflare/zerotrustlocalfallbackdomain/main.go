...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ZeroTrustLocalFallbackDomain)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-cloudflare.zeroTrustLocalFallbackDomain.ZeroTrustLocalFallbackDomainConfig",
		reflect.TypeOf((*ZeroTrustLocalFallbackDomainConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-cloudflare.zeroTrustLocalFallbackDomain.ZeroTrustLocalFallbackDomainDomains",
		reflect.TypeOf((*ZeroTrustLocalFallbackDomainDomains)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-cloudflare.zeroTrustLocalFallbackDomain.ZeroTrustLocalFallbackDomainDomainsList",
		reflect.TypeOf((*ZeroTrustLocalFallbackDomainDomainsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ZeroTrustLocalFallbackDomainDomainsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
