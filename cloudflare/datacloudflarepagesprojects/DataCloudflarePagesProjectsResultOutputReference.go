...
func (d *jsiiProxy_DataCloudflarePagesProjectsResultOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataCloudflarePagesProjectsResultOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
