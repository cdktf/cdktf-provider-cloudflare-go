...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*WorkersForPlatformsScriptSecret)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-cloudflare.workersForPlatformsScriptSecret.WorkersForPlatformsScriptSecretConfig",
		reflect.TypeOf((*WorkersForPlatformsScriptSecretConfig)(nil)).Elem(),
	)
}
