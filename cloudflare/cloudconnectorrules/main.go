...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-cloudflare.cloudConnectorRules.CloudConnectorRulesParameters",
		reflect.TypeOf((*CloudConnectorRulesParameters)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-cloudflare.cloudConnectorRules.CloudConnectorRulesParametersOutputReference",
		reflect.TypeOf((*CloudConnectorRulesParametersOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
