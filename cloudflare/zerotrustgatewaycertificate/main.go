...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "gatewayManaged", GoGetter: "GatewayManaged"},
			_jsii_.MemberProperty{JsiiProperty: "gatewayManagedInput", GoGetter: "GatewayManagedInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "qsPackId", GoGetter: "QsPackId"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetGatewayManaged", GoMethod: "ResetGatewayManaged"},
