...
type RulesetRulesExposedCredentialCheck struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.25.0/docs/resources/ruleset#password_expression Ruleset#password_expression}
	...
	// Refer to the [Firewall Rules language](https://developers.cloudflare.com/firewall/cf-firewall-language).
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.25.0/docs/resources/ruleset#username_expression Ruleset#username_expression}
