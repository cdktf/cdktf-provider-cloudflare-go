...
import (
	...
	"github.com/hashicorp/cdktf-provider-cloudflare-go/cloudflare/v3/emailroutingrule/internal"
...
func (j *jsiiProxy_EmailRoutingRule) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_EmailRoutingRule)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
