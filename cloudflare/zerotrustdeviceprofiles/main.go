...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ZeroTrustDeviceProfiles)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-cloudflare.zeroTrustDeviceProfiles.ZeroTrustDeviceProfilesConfig",
		reflect.TypeOf((*ZeroTrustDeviceProfilesConfig)(nil)).Elem(),
	)
}
