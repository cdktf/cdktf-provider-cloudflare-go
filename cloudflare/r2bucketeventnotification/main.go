...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-cloudflare.r2BucketEventNotification.R2BucketEventNotificationQueues",
		reflect.TypeOf((*R2BucketEventNotificationQueues)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-cloudflare.r2BucketEventNotification.R2BucketEventNotificationQueuesList",
		reflect.TypeOf((*R2BucketEventNotificationQueuesList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*R2BucketEventNotificationQueuesOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-cloudflare.r2BucketEventNotification.R2BucketEventNotificationQueuesRules",
		reflect.TypeOf((*R2BucketEventNotificationQueuesRules)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-cloudflare.r2BucketEventNotification.R2BucketEventNotificationQueuesRulesList",
		reflect.TypeOf((*R2BucketEventNotificationQueuesRulesList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "allWithMapKey", GoMethod: "AllWithMapKey"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*R2BucketEventNotificationQueuesRulesOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
