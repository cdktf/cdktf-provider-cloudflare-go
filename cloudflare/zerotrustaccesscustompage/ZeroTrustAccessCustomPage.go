...
import (
	...
	"github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v12/zerotrustaccesscustompage/internal"
...
func (j *jsiiProxy_ZeroTrustAccessCustomPage) CreatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createdAt",
...
func (j *jsiiProxy_ZeroTrustAccessCustomPage) UpdatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"updatedAt",
...
// Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.1.0/docs/resources/zero_trust_access_custom_page cloudflare_zero_trust_access_custom_page} Resource.
