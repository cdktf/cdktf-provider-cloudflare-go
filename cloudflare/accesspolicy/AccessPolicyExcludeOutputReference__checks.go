...
func (a *jsiiProxy_AccessPolicyExcludeOutputReference) validatePutExternalEvaluationParameters(value interface{}) error {
	...
	case *[]*AccessPolicyExcludeExternalEvaluation:
		value := value.(*[]*AccessPolicyExcludeExternalEvaluation)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*AccessPolicyExcludeExternalEvaluation:
		value_ := value.([]*AccessPolicyExcludeExternalEvaluation)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*AccessPolicyExcludeExternalEvaluation; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_AccessPolicyExcludeOutputReference) validateSetCommonNamesParameters(val *[]*string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
