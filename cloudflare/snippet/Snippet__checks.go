...
func (s *jsiiProxy_Snippet) validatePutFilesParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*SnippetFiles; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_Snippet) validateSetMainModuleParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_Snippet) validateSetNameParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
