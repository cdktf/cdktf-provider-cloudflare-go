...
func (a *jsiiProxy_AccessApplication) validateAddMoveTargetParameters(moveTarget *string) error {
	if moveTarget == nil {
...
func (a *jsiiProxy_AccessApplication) validateImportFromParameters(id *string) error {
	if id == nil {
...
func (a *jsiiProxy_AccessApplication) validatePutCorsHeadersParameters(value interface{}) error {
	...
	case *[]*AccessApplicationCorsHeaders:
		value := value.(*[]*AccessApplicationCorsHeaders)
	...
	case []*AccessApplicationCorsHeaders:
		value_ := value.([]*AccessApplicationCorsHeaders)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*AccessApplicationCorsHeaders; received %#v (a %T)", value, value)
		}
	}
