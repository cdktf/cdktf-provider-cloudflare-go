...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ZeroTrustRiskScoreIntegration)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-cloudflare.zeroTrustRiskScoreIntegration.ZeroTrustRiskScoreIntegrationConfig",
		reflect.TypeOf((*ZeroTrustRiskScoreIntegrationConfig)(nil)).Elem(),
	)
}
