...
import (
	...
	"github.com/hashicorp/cdktf-provider-cloudflare-go/cloudflare/v3/logpushownershipchallenge/internal"
...
func (j *jsiiProxy_LogpushOwnershipChallenge) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
