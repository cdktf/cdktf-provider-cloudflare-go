...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "anonymizedLogsEnabled", GoGetter: "AnonymizedLogsEnabled"},
			...
			_jsii_.MemberProperty{JsiiProperty: "dnsDestinationIpv6BlockIdInput", GoGetter: "DnsDestinationIpv6BlockIdInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetDnsDestinationIpv6BlockId", GoMethod: "ResetDnsDestinationIpv6BlockId"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetDoh", GoMethod: "ResetDoh"},
			_jsii_.MemberMethod{JsiiMethod: "resetDot", GoMethod: "ResetDot"},
