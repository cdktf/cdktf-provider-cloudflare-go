...
func (d *jsiiProxy_DeviceManagedNetworks) validateAddMoveTargetParameters(moveTarget *string) error {
	return nil
}
...
func (d *jsiiProxy_DeviceManagedNetworks) validateImportFromParameters(id *string) error {
	return nil
}
...
func (d *jsiiProxy_DeviceManagedNetworks) validateMoveFromIdParameters(id *string) error {
	return nil
}

func (d *jsiiProxy_DeviceManagedNetworks) validateMoveToParameters(moveTarget *string, index interface{}) error {
	return nil
}

func (d *jsiiProxy_DeviceManagedNetworks) validateMoveToIdParameters(id *string) error {
	return nil
}
...
func validateDeviceManagedNetworks_GenerateConfigForImportParameters(scope constructs.Construct, importToId *string, importFromId *string) error {
	return nil
}
...
func (j *jsiiProxy_DeviceManagedNetworks) validateSetCountParameters(val interface{}) error {
	return nil
}
