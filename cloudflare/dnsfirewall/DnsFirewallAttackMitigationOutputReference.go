...
import (
	...
	"github.com/cdktf/cdktf-provider-cloudflare-go/cloudflare/v12/dnsfirewall/internal"
...
func (d *jsiiProxy_DnsFirewallAttackMitigationOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
